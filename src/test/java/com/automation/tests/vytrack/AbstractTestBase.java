...
//    //will be visible in the subclass, regardless on subclass location
//    //same package or no
//    protected Actions actions;
//
//    @BeforeMethod
//    public void setup(){
//        String URL= ConfigurationReader.getProperty("qa1"); //this is from configuration property file
//        Driver.getDriver(); // this is static, singleton Webdriver from Driver class/Utilities
//                            //with using this i don't have to create Webdriver seperately
...
//        Driver.closeDriver(); // closeDriver is a method from Driver class/Utilities
//    }
//}
//******************************************************************
