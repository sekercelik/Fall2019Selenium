...
public class RegistrationForm {
 ...
 //*****************************************************************************************
   ...
   public void test1(){
    ...
    driver.findElement(passwordBy).sendKeys("12335678945");
    driver.findElement(phoneBy).sendKeys("123-456-6789");
    driver.findElement(maleBy).click();
    driver.findElement(dateOfBirthBy).sendKeys("01/01/2004");
